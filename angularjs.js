...
(function (z) {
   ...
   function Ee(a, b) {
      ...
      d &&
         (Fe
            ? ((e.strictDi = null !== De(d, "strict-di")),
              b(d, c ? [c] : [], e))
            : z.console.error(
         ...
         function (a, b, c, e, p, M, L, u, R) {
            ...
            function aa(a, b, d, e, f, g, h, k, l) {
               ...
               for (
                  ...
                  u.terminal &&
                     ((p.terminal = !0), (n = Math.max(n, u.priority)));
               }
               p.scope = t && !0 === t.scope;
            ...
            function ha(a, b, d, f, g, h, k, l) {
               ...
               return function (a, b, c, d, e) {
                  ...
                  b.$$destroyed ||
                     (m
                        ? m.push(b, c, d, a)
                        : (p.transcludeOnThisElement &&
                             (a = ka(b, p.transclude, e)),
                          p(n, b, c, d, a)));
               };
            }
            function ia(a, b) {
   ...
   function td(a) {
      ...
      for (; b--; ) {
         var d = a[b];
         (8 === d.nodeType ||
            (d.nodeType === Pa && "" === d.nodeValue.trim())) &&
            Kg.call(a, b, 1);
      }
      return a;
   }
            ...
            d.$watch(function () {
               if (N || m.$$urlUpdatedByLocation) {
                  ...
                  var a = c.url(),
                     ...
                     g = m.$$replace,
                     n =
                        !k(a, b) || (m.$$html5 && e.history && f !== m.$$state);
                  if (N || n)
                     (N = !1),
                        d.$evalAsync(function () {
                           var b = m.absUrl(),
         ...
         function (a, b) {
            var d = {},
               c =
                  ...
                  a.history.pushState,
               e = fa(
                  (/android (\d+)/.exec(K((a.navigator || {}).userAgent)) ||
                     [])[1]
               ),
            ...
            function g(k, h) {
               ...
               return c
                  ...
                  .then(
                     ...
                     function (a) {
                        h ||
                           ((a = Zg("tpload", k, a.status, a.statusText)),
                           b(a));
                        return e.reject(a);
                     }
                  );
   ...
   function Vd(a) {
      ...
      return function (a, f, g, k) {
         ...
         a.sort(function (a, b) {
            ...
            return (
               (m(a.tieBreaker, b.tieBreaker) ||
                  c(a.tieBreaker, b.tieBreaker)) * l
            );
         });
            ...
            if (n(a)) {
               ...
               t &&
                  ...
                  (d = c
                     .replace(
                        "ss.sss",
                        k.$options.getOption("timeSecondsFormat")
                     )
                     .replace(/:$/, ""));
               a = m("date")(a, d, b);
               t &&
   ...
   var ze =
      ...
      Fe = (function (a) {
         ...
         if (
            !(
               b instanceof z.HTMLScriptElement ||
               b instanceof z.SVGScriptElement
            )
         )
            return !1;
         b = b.attributes;
   ...
   r(
      {
         ...
         isolateScope: function (a) {
            return (
               x.data(a, "$isolateScope") ||
               x.data(a, "$isolateScopeNoTemplate")
            );
         },
         controller: ld,
         injector: function (a) {
      ...
      if ("function" === typeof a) {
         if (!(c = a.$inject)) {
            ...
            if (a.length) {
               if (b)
                  throw (
                     ((C(d) && d) || (d = a.name || Dg(a)), Ca("strictdi", d))
                  );
               b = qd(a);
      ...
      Of = function () {
         this.$get = [
            ...
            function (a) {
               return function (b) {
                  b
                     ? !b.nodeType && b instanceof x && (b = b[0])
                     : (b = a[0].body);
   ...
   Ld.prototype = {
      ...
      watchFns: function () {
         ...
         r(b, function (b) {
            ...
            b.isPure &&
               a.push(b.name, ".isPure=" + JSON.stringify(b.isPure) + ";");
         });
         b.length &&
            a.push(
               "fn.inputs=[" +
         ...
         if (!f && w(a.watchId))
            ...
            switch (a.type) {
               ...
               case q.Identifier:
                  ...
                  h.if_(
                     "inputs" === h.stage ||
                        h.not(h.getHasOwnProperty("l", a.name)),
                     function () {
   ...
   Sb.prototype = {
      ...
      $$format: function () {
         for (
            var a = this.$formatters, b = a.length, d = this.$modelValue;
            b--;
                        ...
                        ? ((n.writeValue = function (a) {
                             if (v) {
                                ...
                                v.items.forEach(function (a) {
                                   a.element.selected &&
                                      -1 ===
                                         Array.prototype.indexOf.call(b, a) &&
                  ...
                  return function (a, b, h) {
                     ...
                     if (h.hasOwnProperty("ngRefRead"))
                        if ("$element" === h.ngRefRead) l = b;
                           ...
                           if (
                              ((l = b.data("$" + h.ngRefRead + "Controller")),
                              !l)
                           )
